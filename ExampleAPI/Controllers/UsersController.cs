...
using NVIM;
using static NVIM.KPSPublicSoapClient;
...
public class UsersController : Controller
{
    ...
    {
        KPSPublicSoapClient soapClient = new(EndpointConfiguration.KPSPublicSoap12);
        ...
        if (result.Body.TCKimlikNoDogrulaResult == false)
            return BadRequest("Kullanıcı bilgileri yanlış. Tekrar kontrol ediniz!");
